...
conn.welcome = '-------------------------------------------------\n⫷⎝⎝✧ХУЛИГАН✧⎠⎠✍\n│▢๖ۣۜۜ͜͡Приветঔৣֳ᷌᷈͜͡ @user\n│▢♦️Добро пожаловать\n│▢⁉️Прочтите правила группы:\n│▢Не нарушайте их\n@desc\n⚠️ХОРОШЕГО ОБЩЕНИЯ⚠️\n-------------------------------------------------'
conn.bye = '-------------------------------------------------\n@user\n🆘Внимание🆘\n\n *Нас покинул предатель*\nБудте осторожны*\nМожет еще кто нибуть свалить☘\n-------------------------------------------------'
conn.spromote = '*@user 🆘ПРИСОЕДИНИЛСЯ К АДМИНАМ В ЭТОЙ ГРУППЕ🆘!!*'
conn.sdemote = '*@user 🚷БОЛЬШЕ НЕ АДМИН В ЭТОЙ ГРУППЕ🚷*'
conn.sDesc = '*❓ОПИСАНИЕ ГРУППЫ БЫЛО ИЗМЕНЕНО* @desc'
conn.sSubject = '*НАЗВАНИЕ ГРУППЫ БЫЛО ИЗМЕНЕНО❓* @subject'
conn.sIcon = '*❓ГРУППОВАЯ ФОТОГРАФИЯ БЫЛА ИЗМЕНЕНА❓*'
conn.sRevoke = '*❗️ССЫЛКА НА ГРУППУ БЫЛА ОБНОВЛЕНА❗️* @revoke'
