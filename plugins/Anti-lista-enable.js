...
*Описание:* Если к группе присоединяется индуский номер, Бот автоматически удаляет его.
*Примечание: * Необходимо активировать приветствие и ограничение.
--------------------------------
*Вариант:* 👎 | АНТИИНДУС 2
*Команда:* /включить антииндус2
*Описание:* Если в группе пишется индуский номер, Бот автоматически ее удаляет.
...
*Примечание. * Эту команду можно использовать только в группе    antiPrivate
--------------------------------`.trim()
