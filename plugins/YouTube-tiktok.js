...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: texto, contextInfo: { externalAdReply: { title: '⫷᭄©⎝⎝✧ХУЛИГАН✧⎠⎠﹏✍', body: null, thumbnail: imagen1, sourceUrl: 'https://github.com/OFC-YOVANI/HADES-OMEGA' }, mentionedJid: [m.sender]}}}, aa)    
