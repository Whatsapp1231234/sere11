...
await this.sendMessage(m.chat, { text: `*「 АНТИССЫЛКА2 」*\n*Счастливого пути, детка 👋 ${user} Ты нарушил правила группы, ты будешь удален...!!*`, mentions: [m.sender] })  
if (!isBotAdmin) return m.reply('*[❗ИНФО❗] БОТ НЕ ЯВЛЯЕТСЯ АДМИНОМ ГРУППЫ, ОН НЕ МОЖЕТ УДАЛИТЬ НАРУШИТЕЛЯ*')
